...
public class Flicker {
    ...
    private final DcMotor flicker;
    private final Shooter shooter;
    private final double backPower = 0.75; // 1.0
    private final double fwdPower = -0.85; // -0.85
    private final double partialPower = -0.5;
    private final double backDuration = 200; // 300 Duration to wait in msec going back (GOING_BACK)
    private final double fwdDuration = 140; // 145 Duration to wait in msec going forward (GOING_FWD)
    private final double fwdPartial = 50; // Move forward partial
    private final double idleDuration = 300; // Duration to wait for flywheel to expand
    private final double shooterEncoderRotations = Shooter.countPerRotation * 70;
