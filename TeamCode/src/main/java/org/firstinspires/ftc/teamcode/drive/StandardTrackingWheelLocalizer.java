...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.6875; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -7.3125; // in; offset of the lateral wheel
